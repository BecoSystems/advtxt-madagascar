...
int _objetoEscolhido = 0;
int _verboEscolhido = 0;

int main(void) {
   imprima("s", "Em um belo dia ensolarado você está caminhando quando de repente dá de cara com o leão Alex furioso, o que você utiliza para tentar fugir dele \n 1-Queijo mofado \n 2-Bolha d'agua\n");
   _objetoEscolhido = leia_inteiro();
   if((_objetoEscolhido!=2)) {
      imprima("s", "Você desnorteou Alex. Você deseja 1-fugir ou 2-lutar: \n");
      _verboEscolhido = leia_inteiro();
      if((_verboEscolhido!=2)) {
         imprima("s", "Você conseguiu fugir e está vivo\n");
      } else {
         imprima("s", "Alex chama reforços e todos lutam contra você. Você morreu");
      }

   } else {
      imprima("s", "Alex suportou a bolha d'água e correu atrás de você. Você morreu\n");
   }
